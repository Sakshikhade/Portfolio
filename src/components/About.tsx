...
const About: React.FC = () => {
  return (
    <section className="h-full flex items-center justify-center py-12 sm:py-16 md:py-20 bg-white dark:bg-gray-900">
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3">
                <span className="px-3 sm:px-4 py-1 sm:py-2 bg-maroon-100 dark:bg-maroon-900 text-maroon-700 dark:text-maroon-300 rounded-full text-xs sm:text-sm">
                  Python
                </span>
                <span className="px-3 sm:px-4 py-1 sm:py-2 bg-maroon-100 dark:bg-maroon-900 text-maroon-700 dark:text-maroon-300 rounded-full text-xs sm:text-sm">
                  Apache Spark
            ...
            <div className="bg-gradient-to-br from-maroon-50 to-gold-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-4 sm:p-6 md:p-8">
              <div className="grid grid-cols-2 gap-4 sm:gap-6">
                <div className="text-center">
                  <div className="text-2xl sm:text-3xl font-bold text-maroon-600 dark:text-gold-400 mb-1 sm:mb-2">
                    3.72
                  </div>
